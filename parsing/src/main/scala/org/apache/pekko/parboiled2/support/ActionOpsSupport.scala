...
sealed abstract class LowPrioJoin {
  ...
  implicit def forAny[I <: HList, L <: HList, R, In <: HList, Out <: HList](
      implicit x: Aux[I, L, R :: HNil, In, Out]): Aux[I, L, R, In, Out] = `n/a`
}
