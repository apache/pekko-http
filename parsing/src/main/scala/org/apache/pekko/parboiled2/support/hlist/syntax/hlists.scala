...
package org.apache.pekko.parboiled2.support.hlist
package syntax

import org.apache.pekko.parboiled2.support.hlist.ops.hlist.Reverse
...
final class HListOps[L <: HList](l: L) extends Serializable {
   ...
   */
  def ::[H](h: H): H :: L = org.apache.pekko.parboiled2.support.hlist.::(h, l)
