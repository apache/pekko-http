...
import org.apache.pekko.parboiled2.support.OpTreeContext
...
object ParserMacros {
  ...
  def namedRuleImpl[I <: HList: ctx.WeakTypeTag, O <: HList: ctx.WeakTypeTag](
    ...
    val ruleTree = q"""
      ...
      if (matched) org.apache.pekko.parboiled2.Rule else null""" // we encode the "matched" boolean as 'ruleResult ne null'
