...
object ParserMacros {
  ...
  def runImpl[L <: HList: Type, R: Type]()(ruleExpr: Expr[RuleN[L]], schemeExpr: Expr[Parser.DeliveryScheme[L]])(
      using Quotes): Expr[R] = {
  ...
  def ruleImpl[I <: HList: Type, O <: HList: Type](parser: Expr[Parser], r: Expr[Rule[I, O]])(
      using Quotes): Expr[Rule[I, O]] = {
    import quotes.reflect.*
  ...
  def nameRuleImpl[I <: HList: Type, O <: HList: Type](parser: Expr[Parser], name: Expr[String], r: Expr[Rule[I, O]])(
    ...
    '{
      ...
      if (matched) org.apache.pekko.parboiled2.Rule.asInstanceOf[Rule[I, O]] else null
    }
  }
}
