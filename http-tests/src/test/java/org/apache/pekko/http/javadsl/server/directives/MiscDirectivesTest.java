...
public class MiscDirectivesTest extends JUnitRouteTest {
  ...
  public void testClientIpExtraction() throws UnknownHostException {
    ...
    route
      .run(HttpRequest.create().addHeader(org.apache.pekko.http.javadsl.model.headers.RemoteAddress.create(RemoteAddress.create(InetAddress.getByName("127.0.0.3")))))
      .assertStatusCode(StatusCodes.OK)
