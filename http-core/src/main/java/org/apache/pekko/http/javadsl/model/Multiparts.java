...
public final class Multiparts {
    ...
    public static Multipart.FormData createFormDataFromParts(Multipart.FormData.BodyPart... parts) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.createNonStrict(convertArray(parts));
    }
    /**
     * Constructor for `multipart/form-data` content as defined in http://tools.ietf.org/html/rfc2388.
     * All parts must have distinct names. (This is not verified!)
    ...
    public static Multipart.FormData createFormDataFromSourceParts(Source<Multipart.FormData.BodyPart, ? extends Object> parts) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.createSource(parts.asScala());
    }
    ...
    public static Multipart.FormData.Strict createStrictFormDataFromParts(Multipart.FormData.BodyPart.Strict... parts) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.createStrict(convertArray(parts));
    }
    ...
    public static Multipart.FormData.Strict createFormDataFromFields(Map<String, HttpEntity.Strict> fields) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.createStrict(toScalaMap(fields));
    }
    ...
    public static Multipart.FormData createFormDataFromPath(String name, ContentType contentType, Path path, int chunkSize) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.fromPath(name, (org.apache.pekko.http.scaladsl.model.ContentType) contentType, path, chunkSize);
    }
    ...
    public static Multipart.FormData createFormDataFromPath(String name, ContentType contentType, Path path) {
        return org.apache.pekko.http.scaladsl.model.Multipart.FormData$.MODULE$.fromPath(name, (org.apache.pekko.http.scaladsl.model.ContentType) contentType, path, -1);
    }
    ...
    public static Multipart.FormData.BodyPart createFormDataPartFromPath(String name, ContentType contentType, Path path, int chunkSize) {
        return org.apache.pekko.http.scaladsl.model.Multipart$FormData$BodyPart$.MODULE$.fromPath(name, (org.apache.pekko.http.scaladsl.model.ContentType) contentType, path, chunkSize);
    }
    ...
    public static Multipart.FormData.BodyPart createFormDataPartFromPath(String name, ContentType contentType, Path path) {
        return org.apache.pekko.http.scaladsl.model.Multipart$FormData$BodyPart$.MODULE$.fromPath(name, (org.apache.pekko.http.scaladsl.model.ContentType) contentType, path, -1);
    }
    ...
    public static Multipart.FormData.BodyPart createFormDataBodyPart(String name, BodyPartEntity entity) {
        ...
        return org.apache.pekko.http.scaladsl.model.Multipart$FormData$BodyPart$Builder$.MODULE$.create(name, (org.apache.pekko.http.scaladsl.model.BodyPartEntity) entity,
    ...
    public static Multipart.FormData.BodyPart.Strict createFormDataBodyPartStrict(String name, HttpEntity.Strict entity) {
        List nil = Nil$.MODULE$;
        Map<String, String> additionalDispositionParams = Collections.emptyMap();
        return org.apache.pekko.http.scaladsl.model.Multipart$FormData$BodyPart$StrictBuilder$.MODULE$.createStrict(name, (org.apache.pekko.http.scaladsl.model.HttpEntity.Strict) entity,
                convertMapToScala(additionalDispositionParams), nil);
    }
