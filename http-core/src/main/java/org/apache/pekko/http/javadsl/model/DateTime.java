...
public abstract class DateTime {
    ...
    public static Optional<DateTime> fromIsoDateTimeString(String isoDateTimeString) {
        return Util.<DateTime, org.apache.pekko.http.scaladsl.model.DateTime>convertOption(org.apache.pekko.http.scaladsl.model.DateTime.fromIsoDateTimeString(isoDateTimeString));
    }
    ...
    public static DateTime create(int year, int month, int day, int hour, int minute, int second) {
        return org.apache.pekko.http.scaladsl.model.DateTime.apply(year, month, day, hour, minute, second);
    }
}
