...
public abstract class UserAgent extends org.apache.pekko.http.scaladsl.model.HttpHeader {
    ...
    public static UserAgent create(ProductVersion... products) {
        return new org.apache.pekko.http.scaladsl.model.headers.User$minusAgent(org.apache.pekko.http.impl.util.Util.<ProductVersion, org.apache.pekko.http.scaladsl.model.headers.ProductVersion>convertArray(products));
    }
