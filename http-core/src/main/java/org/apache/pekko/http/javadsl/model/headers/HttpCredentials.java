...
public abstract class HttpCredentials {
    ...
    public static HttpCredentials create(String scheme, String token) {
        return new org.apache.pekko.http.scaladsl.model.headers.GenericHttpCredentials(scheme, token, Util.emptyMap);
    }
    public static HttpCredentials create(String scheme, String token, Map<String, String> params) {
        return new org.apache.pekko.http.scaladsl.model.headers.GenericHttpCredentials(scheme, token, Util.convertMapToScala(params));
    }
    public static BasicHttpCredentials createBasicHttpCredentials(String username, String password) {
        return new org.apache.pekko.http.scaladsl.model.headers.BasicHttpCredentials(username, password);
    }
