 ...
 *
 * The basic modelling classes for these media-types ([[org.apache.pekko.http.scaladsl.Multipart.General]], [[Multipart.FormData]] and
 * [[org.apache.pekko.http.scaladsl.Multipart.ByteRanges]], respectively) are stream-based but each have a strict counterpart
 * (namely [[org.apache.pekko.http.scaladsl.Multipart.General.Strict]], [[org.apache.pekko.http.scaladsl.Multipart.FormData.Strict]] and
