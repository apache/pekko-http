...
public abstract class TE extends org.apache.pekko.http.scaladsl.model.HttpHeader {
  public abstract Iterable<org.apache.pekko.http.javadsl.model.TransferEncoding>
      getAcceptableEncodings();

  public static TE create(
      org.apache.pekko.http.javadsl.model.TransferEncoding... acceptableEncodings) {
    return new org.apache.pekko.http.scaladsl.model.headers.TE(
        org.apache.pekko.http.impl.util.Util
            .<org.apache.pekko.http.javadsl.model.TransferEncoding,
                ...
                convertArray(acceptableEncodings));
  }
}
