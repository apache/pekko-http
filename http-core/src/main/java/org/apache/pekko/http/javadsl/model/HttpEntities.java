...
public final class HttpEntities {
    ...
    public static HttpEntity.Strict create(ContentType.NonBinary contentType, String string) {
        return HttpEntity$.MODULE$.apply((org.apache.pekko.http.scaladsl.model.ContentType.NonBinary) contentType, string);
    }

    public static HttpEntity.Strict create(ContentType contentType, byte[] bytes) {
        return HttpEntity$.MODULE$.apply((org.apache.pekko.http.scaladsl.model.ContentType) contentType, bytes);
    }
    ...
    public static UniversalEntity create(ContentType contentType, Path file, int chunkSize) {
        return HttpEntity$.MODULE$.fromPath((org.apache.pekko.http.scaladsl.model.ContentType) contentType, file, chunkSize);
    }

    public static HttpEntity.Default create(ContentType contentType, long contentLength, Source<ByteString, ?> data) {
        return new org.apache.pekko.http.scaladsl.model.HttpEntity.Default((org.apache.pekko.http.scaladsl.model.ContentType) contentType, contentLength, toScala(data));
    }

    public static HttpEntity.Chunked create(ContentType contentType, Source<ByteString, ?> data) {
        return org.apache.pekko.http.scaladsl.model.HttpEntity.Chunked$.MODULE$.fromData((org.apache.pekko.http.scaladsl.model.ContentType) contentType, toScala(data));
    }

    public static HttpEntity.CloseDelimited createCloseDelimited(ContentType contentType, Source<ByteString, ?> data) {
        return new org.apache.pekko.http.scaladsl.model.HttpEntity.CloseDelimited((org.apache.pekko.http.scaladsl.model.ContentType) contentType, toScala(data));
    }

    public static HttpEntity.IndefiniteLength createIndefiniteLength(ContentType contentType, Source<ByteString, ?> data) {
        return new org.apache.pekko.http.scaladsl.model.HttpEntity.IndefiniteLength((org.apache.pekko.http.scaladsl.model.ContentType) contentType, toScala(data));
    }
    ...
    private static org.apache.pekko.stream.scaladsl.Source<ByteString,Object> toScala(Source<ByteString, ?> javaSource) {
