...
public abstract class Server extends org.apache.pekko.http.scaladsl.model.HttpHeader {
    ...
    public static Server create(ProductVersion... products) {
        return new org.apache.pekko.http.scaladsl.model.headers.Server(org.apache.pekko.http.impl.util.Util.<ProductVersion, org.apache.pekko.http.scaladsl.model.headers.ProductVersion>convertArray(products));
    }
}
