...
public abstract class HttpCookie {
    ...
    public static HttpCookie create(String name, String value) {
        return new org.apache.pekko.http.scaladsl.model.headers.HttpCookie(
                name, value,
                Util.<org.apache.pekko.http.scaladsl.model.DateTime>scalaNone(), Util.scalaNone(), Util.<String>scalaNone(), Util.<String>scalaNone(),
                false, false,
    ...
    public static HttpCookie create(String name, String value, Optional<String> domain, Optional<String> path) {
        return new org.apache.pekko.http.scaladsl.model.headers.HttpCookie(
                name, value,
                Util.<org.apache.pekko.http.scaladsl.model.DateTime>scalaNone(), Util.scalaNone(),
