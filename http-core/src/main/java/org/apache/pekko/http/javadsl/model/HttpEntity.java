...
public interface HttpEntity {
     ...
     *
     * Note: It is crucial that entities are either discarded, or consumed by running the underlying [[org.apache.pekko.stream.javadsl.Source]]
    ...
    abstract class ChunkStreamPart {
         ...
         */
        public static final ChunkStreamPart LAST = org.apache.pekko.http.scaladsl.model.HttpEntity.LastChunk$.MODULE$;
        ...
        public static ChunkStreamPart createLast(String extension, Iterable<HttpHeader> trailerHeaders){
            return new org.apache.pekko.http.scaladsl.model.HttpEntity.LastChunk(extension, Util.<HttpHeader, org.apache.pekko.http.scaladsl.model.HttpHeader>convertIterable(trailerHeaders));
        }
    }
}
