 ...
 */
public abstract class LastEventId extends org.apache.pekko.http.scaladsl.model.HttpHeader {
    ...
    public static LastEventId create(String id) {
        return org.apache.pekko.http.scaladsl.model.headers.Last$minusEvent$minusID$.MODULE$.apply(id);
    }
