...
public final class ContentTypes {
  ...
  public static final ContentType.Binary APPLICATION_OCTET_STREAM =
      MediaTypes.APPLICATION_OCTET_STREAM.toContentType();
  ...
  public static final ContentType.Binary APPLICATION_GRPC_PROTO =
      MediaTypes.APPLICATION_GRPC_PROTO.toContentType();
  ...
  public static ContentType.Binary create(MediaType.Binary mediaType) {
    return ContentType$.MODULE$.apply(
        (org.apache.pekko.http.scaladsl.model.MediaType.Binary) mediaType);
  }

  public static ContentType.WithFixedCharset create(MediaType.WithFixedCharset mediaType) {
    return ContentType$.MODULE$.apply(
        (org.apache.pekko.http.scaladsl.model.MediaType.WithFixedCharset) mediaType);
  }

  public static ContentType.WithCharset create(
      MediaType.WithOpenCharset mediaType, HttpCharset charset) {
    return ContentType$.MODULE$.apply(
        (org.apache.pekko.http.scaladsl.model.MediaType.WithOpenCharset) mediaType,
