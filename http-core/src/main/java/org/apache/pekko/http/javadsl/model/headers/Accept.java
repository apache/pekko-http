...
public abstract class Accept extends org.apache.pekko.http.scaladsl.model.HttpHeader {
    ...
    public static Accept create(MediaRange... mediaRanges) {
        return new org.apache.pekko.http.scaladsl.model.headers.Accept(Util.<MediaRange, org.apache.pekko.http.scaladsl.model.MediaRange>convertArray(mediaRanges));
    }
}
