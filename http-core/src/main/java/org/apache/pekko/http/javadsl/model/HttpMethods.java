...
public final class HttpMethods {
    ...
    public static final HttpMethod CONNECT = org.apache.pekko.http.scaladsl.model.HttpMethods.CONNECT();
    ...
    public static final HttpMethod OPTIONS = org.apache.pekko.http.scaladsl.model.HttpMethods.OPTIONS();
     ...
     */
    public static HttpMethod custom(String value, boolean safe, boolean idempotent, org.apache.pekko.http.javadsl.model.RequestEntityAcceptance requestEntityAcceptance) {
    ...
    public static Optional<HttpMethod> lookup(String name) {
        return Util.<HttpMethod, org.apache.pekko.http.scaladsl.model.HttpMethod>lookupInRegistry(HttpMethods$.MODULE$, name);
    }
}
