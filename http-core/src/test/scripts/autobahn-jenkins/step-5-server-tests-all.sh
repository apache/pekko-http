...
SBT_OPTS="-Dsbt.ivy.home=/localhome/jenkinspekko/.ivy2 -Dsbt.override.repos=false"
...
(java $SBT_OPTS -Dpekko.ws-mode=sleep -Dpekko.ws-host=127.0.0.1 -jar $SBT_JAR "pekko-http-core-experimental/test:run-main $TEST_CLASS" | tee output &)
