...
- [akka-http-json](https://github.com/hseeberger/akka-http-json): Integrate some of the best JSON libs in Scala with Apache Pekko HTTP
- [swagger-akka-http](https://github.com/swagger-akka-http/swagger-akka-http): A Scala/Java library for generating Open API (a.k.a. Swagger) from annotated Apache Pekko HTTP code
- [Guardrail](https://github.com/twilio/guardrail): Guardrail is a code generation tool, capable of reading from OpenAPI/Swagger specification files and generating Apache Pekko HTTP code
